...
def hugging_face_api_call(api :str, user_message: str) ->str | None:
...
listening, and understanding.
"""
    output_json         = r"D:\000-University\Uni_Code_Prac\Rooman_Code\mind map\hugging_face_mind_map.json"

    # 1. Calling LLM Api
    raw_response        = hugging_face_api_call(api= api_key, user_message= content)
